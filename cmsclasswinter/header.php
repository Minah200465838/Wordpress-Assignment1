...
<head>
	...
	<link rel="stylesheet"
		href="<?php echo esc_url(home_url('wp-content/themes/cmsclasswinter/assets/css/cmslesson-style.css')); ?>">
	<!-- add our custom font -->
	...
	<header>
		<div>
			<a href="<?php echo esc_url(home_url()); ?>">
				<img src="<?php echo esc_url(home_url('wp-content/uploads/2023/02/sample-logo.png')); ?>"
					alt="header logo">
			</a>
		</div>
		<nav>
